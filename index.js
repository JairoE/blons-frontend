document.addEventListener('DOMContentLoaded', function(){
  ...
  function easy(){
    window.addEventListener('mousemove', drawTrajectory)
    hideLinks()

    GAME.innerHTML += `<div id="monkey" style="bottom: 0px; left: 0px;"></div>`

    gameInterval = setInterval(function(){
      createBallon(ballonYPos())
    }, 1000)
    brdAppearances = setInterval(function() {
      createBird(ballonYPos())
    }, 3000)
